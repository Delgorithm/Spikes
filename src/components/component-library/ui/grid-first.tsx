...
export default function GridFirst() {
  return (
    ...
    >
      {/* Circuit */}
      <Image
        src="/component-library/grid-1-a.svg"
        width={100}
        height={100}
        alt="Paste's icon"
      ...
      {/* Vue JS */}
      <Image
        src="/component-library/grid-1-logo-vue.svg"
        width={100}
        height={100}
        alt="Paste's icon"
        className={cn(
      ...
      {/* Next JS */}
      <Image
        src="/component-library/grid-1-logo-next.svg"
        width={100}
        height={100}
        alt="Paste's icon"
        className={cn(
      ...
      <Image
        src="/component-library/grid-1-logo-react.svg"
        width={100}
        height={100}
        alt="Paste's icon"
        className={cn(
