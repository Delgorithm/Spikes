...
export default function SocialProof() {
  return (
    <section className="text-white flex flex-col items-center">
      ...
      >
        <Image
          src="/component-library/socialproof-5.svg"
          width={100}
          height={100}
          alt="Social Proof"
        ...
        />
        <Image
          src="/component-library/socialproof-4.svg"
          width={100}
          height={100}
          alt="Social Proof"
          style={{ width: "auto", height: "100%" }}
        />
        <Image
          src="/component-library/socialproof-3.svg"
          width={100}
          height={100}
          alt="Social Proof"
          style={{ width: "auto", height: "100%" }}
        />
        <Image
          src="/component-library/socialproof-2.svg"
          width={100}
          height={100}
          alt="Social Proof"
          style={{ width: "auto", height: "100%" }}
        />
        <Image
          src="/component-library/socialproof-1.svg"
          width={100}
          height={100}
          alt="Social Proof"
          style={{ width: "auto", height: "100%" }}
