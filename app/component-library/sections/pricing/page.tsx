...
import { getPricingSection } from "./pricing.query";

export default async function HeroPage() {
	const getPricingData = await getPricingSection();
	const newPricingData = getPricingData.slice(29, 38);
	const firstPricingData = getPricingData.slice(33, 34);
			...
			<section className="grid md:grid-cols-2 md:h-96 gap-10">
				<section className="flex flex-col justify-between">
					<section>
						...
						<small>
							Detailed pricing section with heading and graphique/image centred
				...
				<section className="bg-[#292929] rounded-xl">
					{firstPricingData.map((firstPricing) => (
						<div key={firstPricing.id}>
							<Image
								src={firstPricing.image}
								alt={firstPricing.title}
								width={1000}
								height={500}
