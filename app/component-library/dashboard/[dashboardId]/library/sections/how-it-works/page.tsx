...
export default function HoowitworksPage() {
	const gridItems = [
		{
	...
	return (
		<section className="p-8 flex flex-col gap-10">
				...
				<article className="flex flex-col justify-between">
					<div className="flex flex-col gap-6">
						<div className="flex items-center gap-4">
							<h1 className="text-[26px] text-white">How it works Section</h1>
			...
			<section className="flex flex-col gap-10">
				<h2 className="text-white text-[26px]">Other sections you might like</h2>
